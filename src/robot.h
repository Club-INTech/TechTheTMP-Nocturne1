...
static XL430* motor1 = (XL430*) manager->createMotor(1, XL430GeneratorFunction);//new XL430(1,*manager);
static XL430* motor2 = (XL430*) manager->createMotor(2, XL430GeneratorFunction);//new XL430(2,*manager);
static XL430* motor3 = (XL430*) manager->createMotor(3, XL430GeneratorFunction);//new XL430(3,*manager);
// Liste des moteurs du bras 2
static XL430* motor4 = (XL430*) manager->createMotor(4, XL430GeneratorFunction);//new XL430(4,*manager);
static XL430* motor5 = (XL430*) manager->createMotor(5, XL430GeneratorFunction);//new XL430(5,*manager);
static XL430* motor6 = (XL430*) manager->createMotor(6, XL430GeneratorFunction);//new XL430(6,*manager);
